...
const handler = async (req, res) => {
    ...
    if (!url) return res.status(400).json({ creator: 'Austin', status: false, message: 'Parameter url atau id diperlukan' });
    ...
    try {
        ...
        return res.status(500).json({ creator: 'Austin', status: false, message: err.message });
    }
};
