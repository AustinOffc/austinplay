...
module.exports = async (req, res) => {
    ...
    if (!query) return res.status(400).json({ status: false, creator: 'Austin', message: 'Parameter query diperlukan' });
    ...
    try {
        ...
        return res.status(500).json({ status: false, creator: 'Austin', message: err.message });
    }
};
