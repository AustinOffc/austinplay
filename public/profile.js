var Profile = {
    render() {
        ...
        <div class="pt-6 px-4 text-center">
            ...
            <h1 class="text-3xl font-black chrome-text mb-1">AustinPlay</h1>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-3 text-left mb-6">
                <h3 class="text-white font-bold text-sm uppercase tracking-wider mb-2 flex items-center gap-2">
                    <i data-lucide="smartphone" class="w-4 h-4 text-white/70"></i> Aplikasi & PWA
                </h3>
                <div class="flex justify-between"><span class="text-white/70 text-sm">Nama</span><span class="text-white font-medium text-sm">AustinPlay</span></div>
                <div class="flex justify-between"><span class="text-white/70 text-sm">Versi</span><span class="text-white font-medium text-sm">v1.0.0</span></div>
                <div class="flex justify-between"><span class="text-white/70 text-sm">Mode Offline PWA</span><span class="text-white font-bold text-sm flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-white animate-pulse"></span> Aktif</span></div>
                ...
                <div class="pt-2 border-t border-white/10 flex items-center justify-between">
                    ...
                    <button onclick="if(typeof clearPwaCache==='function') clearPwaCache();" class="text-xs text-white/70 hover:text-white font-semibold underline active:scale-95">Bersihkan Cache</button>
                </div>
            </div>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-4 text-left mb-6">
                <h3 class="text-white font-bold text-sm uppercase tracking-wider mb-2 border-b border-white/10 pb-2 flex items-center gap-2">
                    <i data-lucide="code" class="w-4 h-4 text-white/70"></i> Developer Profile
                </h3>
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-white font-bold text-sm">Austin</span>
                    </div>
                </div>
            ...
            <a href="https://whatsapp.com/channel/0029VbAYbLc7tkizhltuyV1b" target="_blank" class="block w-full max-w-sm mx-auto btn-chrome font-bold py-4 rounded-full active:scale-95 transition-all text-center flex items-center justify-center gap-2">
