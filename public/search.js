var Search={
    ...
    REC_ROWS:[
        {key:'rec0',label:'Rilis Anyar',q:'baru rilis',icon:'<i data-lucide="sparkles" class="w-4 h-4 text-white/70"></i>'},
        {key:'rec1',label:'Barat Top',q:'barat Top',icon:'<i data-lucide="globe" class="w-4 h-4 text-white/70"></i>'},
        {key:'rec2',label:'Rapp Top',q:'Rapp Top',icon:'<i data-lucide="flame" class="w-4 h-4 text-white/70"></i>'}
    ],
    renderRecs(){
